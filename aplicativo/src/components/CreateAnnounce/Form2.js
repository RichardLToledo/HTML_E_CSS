    ...
    return <>
          ...
          <Camps>
           ...
           <CreateType>
              ...
              <h4>Cadastrar Tipo de Propriedade</h4>
              <Input>
                <input type="text" placeholder="Nome do tipo"/>
              </Input>
              <Select option="special">
                <input type="text" list="beth" placeholder="Residencial"/>
                <datalist id="beth">
                    <option value="Residencial" selected/>
                    <option value="Comercial" />
                </datalist>
              </Select>
              <div>
                <Button back="#B4B4B5" ><Link  to="/criar-anuncio">Cancelar</Link></Button>
                <Button ><Link to="/criar-anuncio">Cadastrar</Link></Button>
              </div>
           </CreateType>
            <Input>
